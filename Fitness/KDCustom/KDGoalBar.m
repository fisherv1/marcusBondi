...
-(void)layoutSubviews {
    ...
    labelFrame.origin.y = frame.size.height / 2 - percentLabel.frame.size.height / 2 + 10;
...
-(void)setup {
   ...
   // percentLayer.frame = self.bounds;
    ...
    percentLayer.frame = CGRectMake(0, -10, self.bounds.size.width, self.bounds.size.height);
