    ...
    if (nil != self.labelText) {
        ...
        */
        ...
        if (nil != self.detailsLabelText) {
            ...
            CGSize maximumLabelSize = CGSizeMake(frame.size.width - 4*margin, maxHeight);
            CGSize expectedLabelSize;
            
            CGRect rect = [detailsLabel.text boundingRectWithSize:maximumLabelSize
             ...
             */
            lHeight = expectedLabelSize.height;
            lWidth = expectedLabelSize.width;
